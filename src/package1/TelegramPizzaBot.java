...
public class TelegramPizzaBot extends ProgwardsTelegramBot {
    ...
    public static void main(String[] args) {
        ...
        TelegramPizzaBot bot = new TelegramPizzaBot();
        bot.username = "PizzaJV24bot";
        bot.token = "1241173380:AAHEwZsoRkFSRF5aN1MBkfLaUtst_CWv_ho";

        bot.addTags("привет", "привет, здрасьте, здравствуй, добр, день, вечер, утро, hi, hello");
        bot.addTags("конец", "конец, все, стоп, нет, спасибо, пока, до встречи");
